...
const DEAL_COLUMNS =
  "record_id, name, stage, status, status_6, reference_3, created_at_entry, created_at_record, form_sumary, green_flags_form, tier_5, owner, referral, reconect, reason, contact_status, program";
