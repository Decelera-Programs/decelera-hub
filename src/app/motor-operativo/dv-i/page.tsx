...
import { FUND_META, INVESTMENT_KPIS, MAIN_KPIS, MARKETING_VISITS_KPI, SNAPSHOT_DATE, SQUAD_KPIS } from "@/lib/kpis";
    ...
    <div className="mx-auto flex w-full max-w-6xl flex-col gap-8 px-6 py-8">
      ...
      <section className="flex flex-col gap-3">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {MAIN_KPIS["dv-i"].map((tile) => (
            <InvestmentTile key={tile.id} {...tile} />
          ))}
          <PendingTile
            label="Por definir"
            description="Hasta 6 Main KPIs — resto por definir."
            badge="TBC"
          />
        </div>
      </section>
